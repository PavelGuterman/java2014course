...
import aStar.Action;
import aStar.Domain;
import aStar.IllegalActionExeption;
import aStar.State;
...
public class MazeDomain implements Domain {
	...
	@Override
	public ArrayList<Action> getActions(State state) throws IllegalActionExeption {
		...
		if (isleft && (maze.getPoin(state_i[0], state_i[1] - 1) == maze.getEmpty())){
